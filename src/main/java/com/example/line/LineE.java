...
public class LineE {
    ...
    private final long seed = 9223372036854775807L; //Hardcoded seed als Beispiel 9223372036854775807L ist längste was geht
    ...
    private void createLine(Pane root){
        for (int i = 0; i < 5; i++){
            ...
            pointsList.add(new Points(xPos*50, yPos*50));
        }
